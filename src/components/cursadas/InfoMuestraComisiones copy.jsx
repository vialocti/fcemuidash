      ...
      <Grid container spacing={2}>
                ...
                <Table size="small">
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell><strong>{promedioEncuesta}</strong></TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </TableContainer>
                ...
                <TableBody>
                  {detalleComisiones.map((dato, index) => (
                    <TableRow key={index} hover>
                      ...
                      <TableCell>
                        <Button size="small" variant="outlined" onClick={() => handleOpenModal(docentes.find(d => d.nombre === dato.nombre))}>
                          Ver
                        </Button>
                      </TableCell>
                    </TableRow>
        ...
        <Modal open={modalOpen} onClose={handleCloseModal}>
          <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'background.paper', p: 4, boxShadow: 24, maxHeight: '90vh', overflowY: 'auto' }}>
            {docenteSeleccionado && (
              <InfoEncuestaSeleccion docente={docenteSeleccionado} onClose={handleCloseModal} />
            )}
          </Box>
        </Modal>
      </Grid>
