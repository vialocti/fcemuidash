...
const AspirantesTabs = ({ cantidadSede}) => {
    ...
    <Container maxWidth="xl" sx={{ mt: 3 }}>
      ...
      <Grid item xs={12} md={12} bgcolor={"blue"} color={"white"} sx={{borderRadius:2,width:'97%',p:1,marginBottom:2}}>
            ...
            <Typography variant='h5' textAlign={'center'} >
              Aspirantes </Typography>
        </Grid>
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <Typography variant="body1">
              <strong>Total Aspirantes Primera vez Facultad:</strong> {totalGeneralI}
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
            <Typography variant="body1">
              <strong>Total Aspirantes  por Cambio de Carrera:</strong> {totalGeneralC}
            </Typography>
          </Grid>
        </Grid>
      </Paper>
      ...
      >
        ...
        <Tab label="Aspirantes Ingreso" />
        <Tab label="Cambio de Carrera " />
