...
const HomePage = () => {
  ...
  const [aluactivosProv, setAluactivosProv] = useState({}); //alumnos en calidad de activos por sede
            ...
            {cantidadAlu ? (
              <>
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell>Con Legajo</TableCell>
                  ...
                  <TableRow>  
                      ...
                      <TableCell>{aluactivosProv.mza}</TableCell>
                      <TableCell>{aluactivosProv.sr}</TableCell>
                      <TableCell>{aluactivosProv.ga}</TableCell>
                      <TableCell>{aluactivosProv.es}</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </>
